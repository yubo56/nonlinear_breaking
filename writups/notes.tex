...
We can use this extra degreee of freedom to specify $P(z = L) = P_L$ some
constant. Then we can just simulate away! Let's choose $L = 10, k_x = k_z = 1, H
= 10, g = 10$ which constrains $N^2 \equiv g/H = 1, \omega^2 = \frac{1}{2 +
1/400}$.
