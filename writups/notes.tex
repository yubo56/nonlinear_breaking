...
$\vec{v}_{ph} = \frac{\omega \hat{k}}{\abs{\vec{k}}} = \frac{\omega
\vec{k}}{\abs{\vec{k}}^2}$. Thus, if we have some waveform $f(x, z, t)$, we can
estimate its phase velocity $\vec{v}_{ph}(x, z, t)$ by
\begin{equation}
