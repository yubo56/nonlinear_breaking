...
BCs. Based on our explicit solution \autoref{eq:strat.full_sol} we might expect
to write something like $\pd{u_{1z}}{z} = \frac{1/2H +
ik_z}{\mp i\omega}\pd{u_{1z}}{z} \approx \pm \frac{k_z}{\omega}\pd{u_{1z}}{z}$.
For an outgoing wave we expect to choose the negative sign.
