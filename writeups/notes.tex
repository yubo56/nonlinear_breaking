...
length scale. We make ansatz that the cascade is roughly Kolmogorov, and so
(TODO work this out) we obtain that we should choose $\frac{\omega_0}{k_z^2 \nu}
\sim \p*{\frac{k_{turb}}{k_z}}^{4/3}$; this comes from scaling $\omega, k$ per
the Kolmogorov prescription $\omega_l u_l^2$ is approximately constant over
length scale $l$.
