...
eliminate $S$. We must be careful in taking this approximation (and indeed, it
may be unjustified), since the difference term $\vec{\nabla}\frac{P_1}{\rho_0} -
\frac{\vec{\nabla}P_1}{\rho_0} = -\frac{P_1 \vec{\nabla}\rho_0}{\rho_0^2}$ is
now small as well. What to do with it is dictated by the requirement that
horizontal momentum be conserved. With this in mind, the momentum equation
must be
\begin{equation}
    \pd{\vec{u}_1}{t} + \p*{\vec{u}_1 \cdot \vec{\nabla}}\vec{u}_1
        + \frac{\vec{\nabla}P_1}{\rho_0} + \frac{\rho_1}{\rho_0}g\hat{z} = 0.
\end{equation}
...
\section{The Anelastic/Boussinesq Approximations (old)}
