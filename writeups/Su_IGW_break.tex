...
Fig.~\ref{fig:nl_f_ri}. The Richardson number at the critical layer quickly
decreases to a typical value between $0.25$ and $0.5$, characteristic of the
onset of the KHI\@.
\begin{figure}
    \centering
...
The steadiness of $\mathrm{Ri}$ at this characteristic value suggests that the
critical layer width is self-consistently determined by the ``turbulence'' in
our simulations. The width does not change significantly with resolution in our
resolved simulations (see Fig.~\ref{fig:agg}). Thus, in stars, $\mathrm{Ri} \sim
0.5$ can be used to calculate the critical layer width, where $N^2$ and
