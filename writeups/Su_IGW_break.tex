...
%(likely created by the merger of two He WDs),
R CrB stars,
%(likely created by the merger of a CO and He WD),
AM CVn binaries,
%(possibly created by stable mass transfer from a He WD onto a CO WD),
high-mass neutron stars and magnetars (created by the accretion-induced
collapse of merging WDs),
%CO WDs or accreting O-Ne-Mg WDs),
...
%Fuller \& Lai (20xx,20xx) found that the dissipation of IGW can generate
%significantly more energy than thermal radiation from the isolated WD surface
%and is thus a major contributor to the WD energy budget.
...
\begin{enumerate}
    ...
    \item $\nu$: Nonlinear effects transfer wave energy from the injection
        ...
        \end{equation}
        We use $\mathrm{Re} \gg 1$ in our simulations\footenote{This condition
