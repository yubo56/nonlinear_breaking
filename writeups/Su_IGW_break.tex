...
\citealt{drazin, klostermeyer, winters1994} describe the onset of wave breaking.
...
$0$ over this breaking region. The lost flux is deposited into mean flow
\begin{equation}
...
% TODO stash here
\begin{equation}
    \overline{U}_c \equiv \omega/k_x,
\end{equation}
The further evolution of the critical layer with the incident IGW is
...
\section{Wave Breaking Simulations}\label{s:sim}
...
of the critical layer. As $F$ fluctuates significantly in the simulation, we
measure the location of the critical layer using an average of where flux
deposition occurs
\begin{align}
...
\autoref{eq:zc_anal}. To measure $\Delta F(t)$ across the critical layer $z_c$
...
measuring only the transmitted flux.
